...
This library is not intended as a general-use JWT library; see
[jwt-simple](https://npmjs.org/package/jwt-simple) for that. At the time of
this writing, GoInstant supports the [JWT IETF draft version
8](https://tools.ietf.org/html/draft-ietf-oauth-json-web-token-08).
